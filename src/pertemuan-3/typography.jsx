...
function BackgroundColors(){
    return(
    <div className="bg-teal-500/80 backdrop-blur-sm text-white p-6 rounded-lg shadow-lg border border-teal-300/30">            <h3 className="text-xl font-bold">Tailwind Colors</h3>
