...
export default function FrameworkListSearchFilter() {
  /* 1. Deklarasi state disesuaikan dengan penggunaan dataForm di bawah */
  const [dataForm, setDataForm] = useState({
    searchTerm: "",
    selectedTag: "",
  });

  /* 2. Definisi fungsi handleCange (sesuai typo di JSX) */
  const handleCange = (e) => {
  ...
  const filteredFrameworks = frameworkData.filter((framework) => {
    ...
    /* 3. Perbaikan referensi variabel: selectedTag menjadi dataForm.selectedTag */
