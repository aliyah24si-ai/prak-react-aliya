    ...
    <div id="header-container" className="flex justify-between items-center p-4 bg-white shadow-sm rounded-xl mb-4">
      ...
      <div id="icons-container" className="flex items-center space-x-4 ml-4">
        <div id="notification-icon" className="relative p-3 bg-blue-100 rounded-2xl text-blue-500 cursor-pointer">
          <FaBell />
          <span id="notification-badge" className="absolute top-0 right-0 translate-x-1/2 -translate-y-1/2 bg-blue-400 text-white rounded-full px-1.5 py-0.5 text-[10px] font-bold">
            50
          </span>
        </div>
